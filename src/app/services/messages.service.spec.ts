...
describe('MessagesService', () => {
  ...
  describe('When deleting a post that exists', () => {
    it('should return true', inject([MessagesService, HttpTestingController],
      (service: MessagesService, backend: HttpTestingController) => {
        expect(service.deleteMessageById(1)).toBeTruthy();
